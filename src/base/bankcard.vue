  ...
  <div>
        ...
        <div class="content">
            <div class="pad1">
                <div class="withdraw">
                    <div class="mode">
                        <input type="text" placeholder="请选择银行" v-model="inpop">
                    ...
                    <ul class="verify">
                        ...
                        <li>银行卡号:<input type="number" v-model="cardNum"  placeholder="请填写银行卡"/></li>
                        <li>身份证:<input type="number" v-model="idCard"  placeholder="请填写身份证"/></li>
